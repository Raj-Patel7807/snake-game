...
bool ObstacleManager::tick(int score, long long elapsedMs, int boardWidth, int boardHeight, const std::vector<Point> &snakeCells, const Point &foodPos) {
...
void ObstacleManager::moveSomeObstacles(long long elapsedMs, int boardWidth, int boardHeight, const std::vector<Point> &snakeCells, const Point &foodPos) {
...
void ObstacleManager::regenerate(int score, long long elapsedMs, int boardWidth, int boardHeight, const std::vector<Point> &snakeCells, const Point &foodPos) {
    int scoreBased = 5 + ((score - 50) / 20) * 3;
    if(scoreBased < 5) scoreBased = 5;
